...
(defcustom slack-message-keyword-list-notifier '("")
  "Set up a cons of keywords for notification in slack channels.\n \'(\"keyword1\" \"keyword2\" \"etc.\")"
  :group 'slack
  :type 'cons
  )
...
(defun slack-message-notify-alert (message room team)
  (if (and (not(slack-message-minep message team))
	       ...
	       (string-match (regexp-opt slack-message-keyword-list-notifier)
			     (or (slack-message-body message team) ""))
	       ))
